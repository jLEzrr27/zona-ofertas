            ...
            <tr>
                ...
                <center>
                    <table class="w320 full-width-gmail-android" bgcolor="#f9f8f8" style="background-color:transparent" cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        {!! (isset($data['view']) and !empty($data['view'])) ? $data['view'] : '' !!}
                                ...
                                <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#E5E5E5">
                                        ...
                                        <td class="center" style="padding:25px; text-align:center;">
                                            Este email es a modo de prueba/desarrollo de un pequeño proyecto en laravel para enviar correos.<br><br>
                                            NO es SPAM, ni menos un engaño.
                                            <br><br>
                                            John Lemuel Zárraga Díaz - <b>Full stack Developer</b>
                                        </td>
                                        </tr>
                                    </table>
                                    </td>
